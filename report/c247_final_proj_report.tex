...
In particular, our best performing model on the task of subject independent
classification was the SCNN+LSTM with attention mechanism. 
...
try to improve the performance of our shallow CNN model. Here we discuss a
subset of them and their effect on model performance.
