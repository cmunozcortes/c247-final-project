...
\subsection{Deep CNN}
\subsection{CNN + LSTM with Attention Layer}
This model used an architecture based on \cite{kostas2019machine} by Kostas
\etal. The first part consists of a \emph{spatial} summary convolutional neural
network (SCNN), which includes multiple layers of non-linear spatial
convolutions and temporal convolutions performed separately.  
